    ...
    {/*----------------header ---------------- */}
        ...
        {messagesDummyData.map((msg,index)=>(
            ...
            {msg.image ? (
                ...
                <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.senderId === '' ? 'rounded-br-none' : 'rounded-bl'}`}>{msg.text}</p>
            )}
