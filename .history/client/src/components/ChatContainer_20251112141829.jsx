    ...
    {/*----------------header ---------------- */}
        ...
        {messagesDummyData.map((msg,index)=>(
            ...
            <div className='text-center text-xs'>
                ...
                <p className='test-gray-500'>{fromatMessageTime( msg.createdAt)}</p>
            </div>
        ...
        <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
            <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
                <input  onChange ={(e)=>setInput(e.target.value)} value={input} type='text' placeholder='Send a message' className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400'/>
