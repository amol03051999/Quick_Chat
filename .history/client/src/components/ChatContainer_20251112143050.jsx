    ...
    {/*----------------header ---------------- */}
        ...
        {messages.map((msg,index)=>(
            ...
            <div className='text-center text-xs'>
                <img src={msg.senderId === 0e4f10f3cd28382ecf9' ? assets.avatar_icon : assets.profile_martin } alt='' className='w-7 rounded-full'/>
                <p className='test-gray-500'>{fromatMessageTime( msg.createdAt)}</p>'680f5
            </div>
