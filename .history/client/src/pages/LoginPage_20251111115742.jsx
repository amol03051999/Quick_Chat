  ...
  return (
    ...
    <div className='flex flex-col gap-2'>
         {currentState === 'Sign up' ? (
            <p className='text-sm text-gray-600'>Already have an account ? <span onClick={()=>{setCurrentState('Login');seti}}
            className='font-medium text-violet-500 curspr-pointer'>Login here</span></p>
         ):(
            <p className='text-sm text-gray-600'>Create an account <span
             className='font-medium text-violet-500 curspr-pointer'>Click here</span></p>
         )}
    </div>
    </form>
