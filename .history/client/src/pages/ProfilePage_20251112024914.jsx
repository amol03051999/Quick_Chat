...
const ProfilePage = () => {
  ...
  return (
    ...
    border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        ...
        <img className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`} src={authUser?AuthContext.profilePic || assets.logo_icon} alt=''/>
    </div>
    </div>
  )
}
